...
exports.config = {
    ...
    // on a remote machine).
    runner: 'local',
    hostname:'', //spec reporter throws error if not initiated even if the test passed.
    ...
    sync: true,
    logLevel: 'warn',               // Level of logging verbosity: silent | verbose | command | data | result | error
